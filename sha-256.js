...
/*
*  this algorithm is under free use license, you can use it every where you want
*  the comments are in italian, soyou should translate them if you want to understand it
*  else delete them
*  This file has no copyright and if you are finding for a sha-256 algorithm this si the good one
*  After all if you are here you should be so much desperate
*/
function sha(stringa) { //stringa is the string that get passed and will be assegned to F
    var f = stringa;
